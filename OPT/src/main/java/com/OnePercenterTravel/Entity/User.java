...
// Allows spring to see your file as entity
// Entity's are classes that you use to create an objest
// that will eventually be stored in the database
@Entity

// Tells spring that the entitiy will correlate to the table in the
...
public class User {
    ...
    @Column(name = "isAdmin")
    private Boolean isAdmin;                // ROLL_ADMIN, ROLL_USER, ROLE_TESTER, ROLE_LEVEL100


    @OneToMany
    // On a one to many, you state the parent as the foriegn key, to be placed on the child
